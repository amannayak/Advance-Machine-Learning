...
fnPredict = function(trainData , testData , DAGraph.bnObject , predNode = "S" , Method = "Bayes"){
  
  #fit bn model to training Data 
  modelFit = bnlearn::bn.fit(x = DAGraph.bnObject , data =trainData , method = Method)
  ...
  for(i in 1:nrow(testData))
  {
    ...
    testDataRow.State = as.vector(unname(unlist(test[i, -2])))
