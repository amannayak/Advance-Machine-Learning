...
fnPredict = function(trainData , testData , DAGraph.bnObject , predNode = "S" , Method = "bayes" , markovB = FALSE , markovObj = NULL){
  ...
  for(i in 1:nrow(testData))
  {
    ...
    prediction[i] = ifelse(queryGrain$S["yes"] > queryGrain$S["no"]  ,  "yes" , "no")
